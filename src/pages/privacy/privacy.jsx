        ...
        <div className="privacy">
            <div className="privacy-content">
                <h1 className='container'>
                    Privacy Policy for Bankit
                </h1>
                <hr />

                <div className='container'>
                    <h2 className='h-spacer'>
                        Privacy Policy
                    </h2>
                    <span className='spacer'>Last updated: October 17, 2024</span>
                ...
                <div className="container">
                    <h3 className='h-spacer'>
                        Interpretation and Definitions
                    </h3>

                    <h4 className='h-spacer-mini'>
                        Interpretation
                    </h4>
                    ...
                    <ul>
                        ...
                        <li>
                            <strong>Application</strong> refers to Bankit, the software program provided by the Company.
                        </li>

                        <li>
                            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Bankit Microfinance Bankit Limited, 116 Apapa-Oshodi Express Way, Isolo, Lagos, Nigeria.
                        </li>
                        ...
                        <li>
                            <strong>Usage</strong> Data refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).
                        </li>
                ...
                <div className="container">
                    ...
                    <ul>
                        <li>
                            By email: hello@bankitafrica.com
                        </li>

                        <li>
                            By visiting this page on our website: <a href='https://bankitafrica.com/support' rel="noreferrer" target='_blank'>https://bankitafrica.com/support</a>
                        </li>

                        <li>
                            By phone number: +2347059864396
                        </li>
